package com.lamaviedelivery.utils;
...
import com.lamaviedelivery.SplashAct;
...
public class SessionManager {
    ...
    public static final String PREF_NAME = "LamavieDelivery";
    ...
    public static void Logout(String id, Context context,String token) {
        LamavieDeliveryInterface apiInterface = ApiClient.getClient().create(LamavieDeliveryInterface.class);
                ...
                try {
                    ...
                    if(data.get("status").equals("1")){
                       ...
                       // DataManager.updateResources(context,"en");
                        Intent intent = new Intent(context, LogWithMobileAct.class);
                        intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK | Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_NO_HISTORY);
                        context.startActivity(intent);
                    }
